...
import 'package:flutter_weather/view_models/weather_view_model.dart';
                            ...
                            child: Column(
                              children: <Widget>[
                                ...
                                Container(
                                  ...
                                  child: ListView.builder(
                                    scrollDirection: Axis.horizontal,
                                    itemCount: data?.dailyForecast.length ?? 0,
                                    padding: const EdgeInsets.only(),
                                    itemBuilder: (context, index) {
                                      return data?.dailyForecast[index] != null
                                          ? _buildDailyItem(
                                              daily: data!.dailyForecast[index],
                                              maxTemp: maxTemp,
                                              minTemp: minTemp)
                                          : null;
                                    },
  ...
  Widget _buildContent(
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        StreamBuilder<Sentence>(
            stream: _viewModel?.sentence.stream,
            builder: (context, snapshot) {
              print('weater_city_page sentence 3');
              final sentence = snapshot.data;
              String content = sentence?.content ?? '';
              String newSentence = content.replaceAllMapped(
